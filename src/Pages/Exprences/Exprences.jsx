...
const Exprences = () => {
    return (
        <div className='lg:px-28 md:px-20 sm:px-12 px-10 py-8'>
            <div>
                 <p className="text-[#EDCEAB] font-medium uppercase py-2">MY EXPERIENCE</p>
                 <h2 className="lg:text-4xl md:text-4xl sm:text-3xl text-2xl font-extrabold text-[#ffffff]">EXPERIENCE AND <span className="text-[#EDCEAB]">SKILL</span></h2>
            </div>
