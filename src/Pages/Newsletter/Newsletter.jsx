        ...
        <div className="newletter_bg">
            <div className='lg:px-28 md:px-20 sm:px-12 px-10 py-20'>
                <div className='flex items-center justify-center flex-col text-center text-[#ffffff]'>
                    <p className='text-[#EDCEAB] font-medium py-2 text-xl'>NEWSLETTER</p>
                    ...
                    <form className='my-6 flex items-center space-x-3'>
                        <input
                            className='py-2 px-2 border-2 border-[#EDCEAB] text-lg rounded lg:w-[40vh] w-full outline-none bg-transparent'
                            type="text" placeholder='Enter Your Email..' />
                        <button className='bg-[#EDCEAB] border border-[#EDCEAB] hover:bg-transparent duration-300 text-center px-6 rounded text-[#ffffff] py-2 flex items-center justify-center space-x-4'>
                            <span>SUBSCRIBE</span>
